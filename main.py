...
if __name__ == "__main__":
    logger = Logger("[https://t.me/MemoryOfNaengi]")
    logger.log("Blum Bot Auto By ANOM")
    ...
    # request desired number of points
    answer = None
    while answer is None:
        points_key = logger.input(
            "Indicate the desired number of points | 1 -> 90-110 | 2 -> 140-160 | 3 -> 170-180 | 4 -> MAX: ")
        answer = PERCENTAGES.get(points_key, None)
        if answer is None:
            logger.log("Invalid value")
    percentages = answer

    # request whether to click on 'Play'
    answer = None
    answs = {
        "1": True,
        "0": False
    ...
    while answer is None:
        points_key = logger.input("Should the bot continue games automatically? | 1 - yes / 0 - no: ")
